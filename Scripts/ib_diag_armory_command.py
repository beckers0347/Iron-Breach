...
TARGETS_EXACT = [
    "SM_Armory_Tripo", "07_Armory_DoorFrame",
    "SM_Command_Tripo", "08_Command & Comms_DoorFrame",
]
PREFIXES = ["07_Armory_Collision", "08_Command & Comms_Collision"]
...
def main():
    ...
    # also dump mesh local bounds for the two exterior actors
    for label in ["SM_Armory_Tripo", "SM_Command_Tripo"]:
        for a in all_actors:
